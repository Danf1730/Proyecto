...
<body>
    ...
    Información del usuario que tiene más suscripciones de pólizas, de dónde es y la cantidad de pólizas por tipo de póliza que posee.
        ...
        <table class="table">
            <thead>
                ...
                <th scope="col">Tipo póliza posee</th>
