...
<div class="row mt-5">
	...
	<ul>
		<a href="#" style="text-decoration:none"><li>Consultar poliza de Vehiculo</li></a>
        <a href="#" style="text-decoration:none"><li>Consultar vehiculo</li></a>
        <a href="#" style="text-decoration:none"><li>Consultar Multas</li></a>
	</ul>
	
	
	</div>

	<div class="col-6 col-s-9  ml-4 mb-5">
